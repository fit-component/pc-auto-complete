    ...
    _createClass(AutoComplete, [{
        ...
        value: function render() {
            ...
            var Items = this.state.filterDatas.map(function (item, index) {
                ...
                var matchedString = item[_this6.props.parse.text].replace(regex, '<span class="highlight">' + _this6.searchValue + '</span>');

                isEmpty = false;

                return _react2.default.createElement('div', { onClick: _this6.handleSelect.bind(_this6, item[_this6.props.parse.text], item[_this6.props.parse.value], index, true, true),
                    key: index,
                    className: itemClass,
